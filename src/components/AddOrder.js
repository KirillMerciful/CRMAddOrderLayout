              ...
              <tr>
                ...
                data-value={this.props.pdkon === 0 ? 
                  ...
                  id={"OrdPosTotSum" + this.props.orderPosition.idOrd}>
                  {
                    ...
                    :this.props.orderPosition.Proverka36 !== true ? this.props.orderPosition.totaldkprice + " руб." : this.props.orderPosition.totaldkprice36 + " руб." /*также проверяет активен ли переключатель цен на дк */
                  }
                </td>
              </tr>
